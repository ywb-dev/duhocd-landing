    ...
    <section id="signup">
        <div class="relative pt-24 pb-40 md: bg-[#D9D9D9]">
            <div class="mb-9 text-center ">
                ...
                <h2 class="w-80 my-4 md:w-full mx-auto text-32 leading-9 md:text-68 md:leading-normal text-dark text-center font-bold -traccking-[1px]">Đăng kí nhận tư vấn cụ thể</h2>
            ...
            <div class="px-10 xs:px-16 max-w-[564px] mx-auto">
                <form  @submit="handleSubmit">
                    ...
                    <div class="group-field">
                        ...
                        <input v-model="formData.dob" id="dob" name="dob" type="date"  placeholder="00/00/0000"/>
                    </div>
                    <div class="flex justify-between">
                         <div class="group-field w-28">
                            <label class="flex" for="#sex"><StarIcon class="mr-1"/>Giới tính</label>
                        
                            <div class="relative">
                                <select v-model="formData.sex" title="click để chọn giới tính" name="sex" id="sex">
                                    <option value="1">Nam</option>
                                    <option value="0">Nữ</option>
                                </select>
                                <DropdownIcon class="absolute w-5 text-base right-4 top-1/2 -translate-y-1/2"/>
                            </div>
                        </div>
                        <div class="group-field flex-1 ml-4 w-7/12">
                            <label class="flex" for="#phone"><StarIcon class="mr-1"/>Số điện thoại</label>
                            <input v-model="formData.phone" id="phone" name="phone" type="text"/>
                        </div>
                    </div>
                    <div class="group-field">
                        <label class="flex" for="#email"><StarIcon class="mr-1"/>Email</label>
                        <input v-model="formData.email" id="email" name="email" type="email" placeholder="youremail@domain.com"/>
                    </div>
                    <div class="group-field">
                        <label class="flex" for="dropdown"><StarIcon class="mr-1"/>Nơi thường trú</label>
                   ...
                   <div class="group-field">
                        <label class="flex" for="dropdown"><StarIcon class="mr-1"/>Quê quán</label>
                        <div class="flex gap-2">
                            <div class="">
                    ...
                    <div class="group-field">
                        ...
                        <textarea v-model="formData.question" title="để mở rộng bạn có thể kéo góc dưới bên phải của trường" class="relative h-72 py-8" id="thoigianduhoc" name="thoigianduhoc" placeholder="Bạn hãy thoải mái đặt câu hỏi ở đây nhé!"/>
                    </div>
                    <div class="group-field">
