            ...
            <div class="max-w-[1136px] container">
                <div class="flex flex-col md:flex-row justify-center items-center pt-20 md:-mt-7 min-h-[632px]">
                    <div 
                        ...
                        <h2 class="font-poppins text-23 lg:text-[42px] leading-[56px] tracking-tight font-normal lg:mt-8">
                            <span class="font-semibold">Tất tần tật</span> về du học</h2>

                        <h1
                            class="text-dark text-5xl lg:text-[92px] font-poppins font-bold -tracking-[3.22px] lg:leading-[95px]">
                            Hàn Quốc</h1>
