            ...
            <div class="container max-w-960 mx-auto px-5 ">
                ...
                <div v-motion
                    ...
                    <div v-motion-slide-visible-left class="-mt-20 step relative relative md:mt-6 md:flex md:items-end md:justify-end">
                        <img class="relative max-w-[250px] md:max-w-full z-10 ml-auto md:ml-0" src="/images/flows/person5.png" loading="lazy" alt="đăng ký bước 1">
                        <div class="flex md:items-center">
                    ...
                    <div v-motion-slide-visible-right class="-mt-20 step relative md:mt-10  md:flex md:items-end md:justify-end md:flex-row-reverse">
                        <img class="relative max-w-[250px] md:max-w-full z-10 md:absolute md:ml-auto md:right-12 -top-8" src="/images/flows/person8.png" loading="lazy" alt="đăng ký bước 1">
                        <div class="flex md:items-center">
                            ...
                            <img class="absolute -mt-6 md:mt-48 md:-mr-8 -right-8 md:static" src="/images/flows/number6.png" loading="lazy" alt="đăng ký bước 1">
                        </div>
                    ...
                    <div v-motion-slide-visible-left class="-mt-20 step relative md:mt-0 md:flex md:items-end md:justify-center">
                        <img class="relative max-w-[250px] md:max-w-full z-10 md:absolute md:ml-auto md:left-24 -top-14" src="/images/flows/person6.png" loading="lazy" alt="đăng ký bước 1">
                    ...
                    <div v-motion-slide-visible-right class="-mt-20 step relative md:mttt-0 md:flex md:items-end md:justify-end md:flex-col-reverse">
                        <img class="md:-mt-12 max-w-[250px] md:max-w-full" src="/images/flows/person7.png" loading="lazy" alt="đăng ký bước 1">
