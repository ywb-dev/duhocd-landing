                ...
                <div class="w-full border-[10px] border-primaryText bg-[#EFE9DB] rounded-[45px] overflow-hidden">
                    <div class="flex flex-col md:flex-row border-primaryText">
                        ...
                        <div class="w-full md:w-1/2">
                            <div class="text-25 text-[#1E1E1E] leading-normal font-normal py-6 px-12 text-center md:text-left md:border-l-2 border-primaryText">
                                Chuyên ngành và trường học
                            </div>
                            <div class="text-25 text-[#1E1E1E] leading-normal font-normal py-6 px-12 text-center md:text-left md:border-l-2 border-t-2 border-primaryText">
